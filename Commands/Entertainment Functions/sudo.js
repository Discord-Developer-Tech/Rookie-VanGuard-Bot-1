...
$onlyIf[$noMentionMessage!=;$getVar[nah] Incorrect usage! Correct usage: \`sudo <@user> <message>\`]
$onlyIf[$mentioned[1]!=;$getVar[nah] Incorrect usage! Correct usage: \`sudo <@user> <message>\`]
`
}