...
$else
$if[$getGlobalUserVar[gem22]==on]
Pog you farmed up $message pepper plants and earned \`$numberSeparator[$multi[$message;90];,]\`$getServerVar[simbol]
!
  
$setGlobalUserVar[plant;$sub[$getGlobalUserVar[plant];$multi[$message;1]]]

  $setGlobalUserVar[cash;$sum[$getGlobalUserVar[cash];$multi[$message;90]]]
...
$onlyIf[$getGlobalUserVar[Blacklist;$authorID]==false;{author:Oh no} {color:RED} {thumbnail:https://media.discordapp.net/attachments/903038778229268541/903415958243246100/22841a994e9477aaf121a8844c07ebf0.png} {description:Oh no <@$authorID> you are blacklisted from using my commands make sure to dm my Owner $userTag[$botownerid] for more info}]
$else
Pog you farmed up $message pepper plants and earned \`$numberSeparator[$multi[$message;30];,]\`$getServerVar[simbol]
!
